...
bool RunApp()
{
    ...
    SDL_Window *window = SDL_CreateWindow("ProsperoAI", SDL_WINDOWPOS_UNDEFINED,
    ...
    if (running)
        running = LoadFonts();
    Rml::Context *context =
        running ? Rml::CreateContext("prosperoai", {1920, 1080}, adapted_render_interface)
                : nullptr;
